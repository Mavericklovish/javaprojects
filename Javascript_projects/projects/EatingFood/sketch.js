...
class Animal{
	...
	GetSpeed(){
		...
		//let MassSquared = this.GetMass() * this.GetMass()
		//return this.GetEnergyConsumptionPerFrame()/(MassSquared*dragConstant)
	}
	Move(){  //Return IsAlive
	...
	DetectColisionWithFood(){
		...
		//let nextDeistance = Math.sqrt(dx*)
...
function draw() {
	...
	//forEvery(animals,(animal)=>animal.Move())
